...
public class DashRendererBuilder implements RendererBuilder {
  ...
  private static final class AsyncRendererBuilder
    ...
    private void buildRenderers() {
      ...
      TrackRenderer videoRenderer = new MediaCodecVideoTrackRenderer(context, videoSampleSource, MediaCodec.VIDEO_SCALING_MODE_SCALE_TO_FIT, 5000, drmSessionManager, true,
