...
public class ImaPlayer {
    ...
    /**
     * The activity's original orientation, used when coming back from fullscreen
     */
    ...
    /**
     * Listener that the caller may provide in order to receive
     * playback state change events about the content player
     */
    ...
    private void registerLifecycleCallback() {
        if (this.activity != null) {
            ...
            if (app != null) {
                this.lifecycleCallback = new Application.ActivityLifecycleCallbacks() {
                    @Override
    ...
    private void unregisterLifecycleCallback() {
        if (this.activity != null) {
            Application app = this.activity.getApplication();
            if (app != null) {
                app.unregisterActivityLifecycleCallbacks(this.lifecycleCallback);
            }
        }
    }
     ...
     * will be visible on the player.
     *
     * @param shouldShowFullscreen boolean of whether or not the toggle button will appear
     *
     */
    public void setIsFullscreenToggleVisible(boolean shouldShowFullscreen) {
        if (adPlayer != null) {
            adPlayer.setIsFullscreenToggleVisible(shouldShowFullscreen);
        } else {
            contentPlayer.setIsFullscreenToggleVisible(shouldShowFullscreen);
        }
    }
    ...
    /**
     * Force the player to enter fullscreen mode.
     * @param isFullscreen The flag that will force the fullscreen mode.
     */
    public void setFullscreen(boolean isFullscreen) {
        if (adPlayer != null) {
            adPlayer.setFullscreen(isFullscreen);
        } else {
            contentPlayer.setFullscreen(isFullscreen);
        }
    }
    /**
